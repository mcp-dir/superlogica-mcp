...
Superlógica Condomínios segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Superlógica** | BR | Condo management ERP API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [superlogica@mcp.ai](mailto:superlogica@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
